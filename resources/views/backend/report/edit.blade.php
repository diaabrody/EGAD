...
@section ('title','Report Management' . ' | ' . 'Report Edit')


@section('content')
    {{ html()->modelForm($report,'PATCH', route('admin.report.report.update', $report->id))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                                Report Management
                            <small class="text-muted">Edit Report</small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
